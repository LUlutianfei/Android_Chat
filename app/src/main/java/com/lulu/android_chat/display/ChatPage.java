...
public class ChatPage extends Activity {
    ...
    private void initChat() {
        List<Chat> chats = LitePal.findAll(Chat.class);
        for(Chat chat:chats){
            chatList.add(chat);
        }
    }
    ...
    private void event() {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            if(!"".equals(content)){
                ...
                if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    notification= new Notification.Builder(ChatPage.this, channelId)
                    ...
                    notification= new Notification.Builder(ChatPage.this)
                            .setContentTitle(name)
                            .setContentText(content)
                            .setWhen(System.currentTimeMillis())
                            .setSmallIcon(headImg)
                ...
                Chat chat = new Chat(content,Chat.TYPE_SEND,sdf.format(date));
                chat.save();
                chatList.add(chat);
        ...
        location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ChatPage.this,Location.class));
            }
        });
    }
